...
export const UPLOAD_WHISPER_MISSING_MESSAGE = "Whisper Small + VAD chưa đầy đủ. Hãy mở Cài đặt → Thành phần cục bộ để tải hoặc bổ sung VAD trước khi thêm hay trích xuất lại âm thanh.";
